...
## 📑 Task Breakdown
- **Task 1:** Implemented a Sentence Transformer using BERT.  
- **Task 2:** Expanded to Multi-Task Learning with two classification heads.  
- **Task 3:** Discussed training strategies and transfer learning.  
- **Task 4:** Created a structured training loop for the multi-task model.  

## 📝 Final Notes
- Code follows **PEP 8 guidelines**.
- Notebooks are **well-structured and modular**.
- Models are designed for **scalability and future improvements**.
